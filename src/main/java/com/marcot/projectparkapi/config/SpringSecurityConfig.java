    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "api/v1/parking-spots").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "api/v1/parking-spots").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "api/v1/parking-spots/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "api/v1/parking-spots/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "api/v1/parking-spots/**").hasRole("ADMIN")
